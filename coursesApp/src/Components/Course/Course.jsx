...
const Course = () => {
    ...
    <div className="course-container w-full">
        <div className="course-header bg-gray-300 p-5 md:max-h-72 flex flex-col">
