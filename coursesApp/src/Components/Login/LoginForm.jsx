  ...
  return (
    <form className="max-w-md mx-auto">
      ...
      <div className="flex items-center justify-between mt-4">
        ...
        <a href="#" className="text-indigo-500">Ја заборави лозинката?</a>
      </div>

      <div className="mt-6 flex justify-between">
        <button type="submit" className="w-1/2 bg-indigo-500 text-white py-2 px-4 rounded focus:outline-none focus:shadow-outline mr-2">Логирај се</button>
        <button type="submit" className="w-1/2 border border-indigo-500 text-indigo-500 py-2 px-4 rounded focus:outline-none focus:shadow-outline ml-2">Регистрација</button>
      </div>
    </form>
  );
};
